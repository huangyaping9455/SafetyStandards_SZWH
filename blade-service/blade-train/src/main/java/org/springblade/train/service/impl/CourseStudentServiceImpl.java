...
import org.springblade.train.mapper.CourseStudentMapper;
...
public class CourseStudentServiceImpl extends ServiceImpl<CourseStudentMapper, CourseStudent> implements ICourseStudentService {
    ...
    @Override
    public boolean insertCourseStudentSelective(CourseStudent courseStudent) {
        return courseStudentMapper.insertCourseStudentSelective(courseStudent);
    }
}
