...
public interface ExamMapper extends BaseMapper<Exam> {
     ...
     * @return
     */
    List<CourseTestRecord> getCourseTestRecordList(CourseTestRecordPage courseTestRecordPage);
    int getCourseTestRecordTotal(CourseTestRecordPage courseTestRecordPage);
