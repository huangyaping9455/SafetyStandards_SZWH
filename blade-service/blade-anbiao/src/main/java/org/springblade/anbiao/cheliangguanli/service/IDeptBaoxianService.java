 ...
 * @since 2022-10-31
 */
public interface IDeptBaoxianService extends BaseService<DeptBaoxian> {
	 ...
	 * @return
	 */
	IPage<DeptBaoxianVO> selectDeptBaoxianPage(IPage<DeptBaoxianVO> page, DeptBaoxianVO deptBaoxian);
