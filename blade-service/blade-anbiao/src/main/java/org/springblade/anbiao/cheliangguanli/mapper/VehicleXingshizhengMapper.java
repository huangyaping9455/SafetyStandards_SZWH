 ...
 * @since 2022-10-28
 */
public interface VehicleXingshizhengMapper extends BaseMapper<VehicleXingshizheng> {
	 ...
	 * @return
	 */
	List<VehicleXingshizhengVO> selectVehicleXingshizhengPage(IPage page, VehicleXingshizhengVO vehicleXingshizheng);
