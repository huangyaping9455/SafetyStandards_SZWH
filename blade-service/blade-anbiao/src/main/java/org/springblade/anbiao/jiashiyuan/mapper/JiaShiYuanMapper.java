...
public interface JiaShiYuanMapper extends BaseMapper<JiaShiYuan> {
	...
	List<JiaShiYuanTJMX> selectAlarmTJMXPage2(JiaShiYuanPage jiaShiYuanPage);
	int selectAlarmTJMXTotal2(JiaShiYuanPage jiaShiYuanPage);
	...
	List<DriverTJMingXiVO> getDriverTJMingXi( DriverTJMingXiVO driverTJMingXiVO );
