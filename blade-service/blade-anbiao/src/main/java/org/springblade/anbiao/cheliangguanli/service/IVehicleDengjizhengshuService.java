 ...
 * @since 2022-10-28
 */
public interface IVehicleDengjizhengshuService extends BaseService<VehicleDengjizhengshu> {

	/**
	 * 自定义分页
	 *
	 * @param page
	 * @param vehicleDengjizhengshu
	 * @return
	 */
	...
	VehicleDengjizhengshu selectVehicleDengjizhengshuByVehicleIds(String avdVehicleIds);
}
