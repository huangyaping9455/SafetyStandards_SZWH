 ...
 * @since 2019-06-06
 */
public interface BaoBiaoSecurityParameterInfoMapper extends BaseMapper<BaoBiaoSecurityParameterInfo> {
	 ...
	 * @return
	 */
	List<BaoBiaoSecurityParameterInfo> getAll(RiChengAnPaiPage riChengAnPaiPage);
	int getAllTotal(RiChengAnPaiPage riChengAnPaiPage);
	 ...
	 * @return
	 */
	List<BaoBiaoSecurityParameterInfo> getAllByDept(RiChengAnPaiPage riChengAnPaiPage);
	int getAllByDeptTotal(RiChengAnPaiPage riChengAnPaiPage);
