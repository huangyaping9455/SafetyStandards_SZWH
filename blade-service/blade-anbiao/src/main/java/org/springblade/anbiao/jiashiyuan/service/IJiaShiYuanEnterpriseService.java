 ...
 */
public interface IJiaShiYuanEnterpriseService extends IService<JiaShiYuanEnterprise> {
	 ...
	 * @return
	 */
	JiaShiYuanPage<JiaShiYuanEnterprise> selectPageList(JiaShiYuanPage jiaShiYuanPage);
